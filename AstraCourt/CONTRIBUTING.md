# Contributing to AstraCourt 🌌

Thank you for your interest in contributing to AstraCourt! We welcome community contributions, bug reports, feature requests, and documentation improvements.
...
3.  **Create a Branch**: Create a descriptive branch name (e.g. `feat/slash-staking` or `fix/lcg-seed`).
